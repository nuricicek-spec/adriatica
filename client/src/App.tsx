...
const EngineeringPlans = lazy(
  () => import("@/pages/services/EngineeringPlans"),
);
const EngineeringDocs = lazy(() => import("@/pages/services/EngineeringDocs"));
const StructuralIntegrity = lazy(
  () => import("@/pages/services/StructuralIntegrity"),
);
const SustainableTech = lazy(() => import("@/pages/services/SustainableTech"));
const RegulatoryCompliance = lazy(
  () => import("@/pages/services/RegulatoryCompliance"),
);
...
function Router() {
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        <Route
          path="/services/engineering-plans"
          component={EngineeringPlans}
        />
        <Route
          path="/services/engineering-documentation"
          component={EngineeringDocs}
        />
        <Route
          path="/services/structural-integrity"
          component={StructuralIntegrity}
        />
        <Route
          path="/services/sustainable-technologies"
          component={SustainableTech}
        />
        <Route
