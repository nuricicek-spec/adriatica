...
export default function Philosophy() {
  // Schema.org yapısı (WebPage / AboutPage)
      ...
      <div className="min-h-screen bg-[#0B3B5C] font-body selection:bg-primary/20">
        ...
        <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            {/* Başlık alanı - sayfanın üst kısmında, felsefe manifestosuna giriş */}
            <div className="text-center mb-16">
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
                The Adriatica Standard
              </h1>
              <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto">
                Precision is not just a method—it is our philosophy.
              </p>
            </div>

            {/* Ana içerik: iki sütun (metinler + görsel) */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              {/* Sol sütun: metinler ve istatistikler */}
              <div>
                <SectionHeading
              ...
              {/* Sağ sütun: görsel kart (Pinecone SVG ve efektler) */}
            ...
            {/* Ek açıklama veya alıntı - sayfa altında opsiyonel */}
