...
// Philosophy bölümünün özel stilleri (home.tsx'ten aynen alındı, görsel için gerekli)
        ...
        <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <SectionHeading
              ...
              subtitle="Philosophy & Standard"
            />

            {/* İçerik Kartı */}
            <div className="bg-white rounded-sm shadow-lg overflow-hidden border border-border/10">
              {/* Lacivert Felsefe Bloğu */}
              <div className="bg-[#0B3B5C] text-white p-8 md:p-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-white/80 leading-relaxed mb-8">
                      Our approach is reductive: we remove the unnecessary to
                      reveal the essential structure. This discipline results in
                  ...
                  <div className="relative">
                    ...
                    <div className="aspect-[4/5] mx-auto max-w-sm lg:max-w-none">
              ...
              {/* Alt CTA Bölümü (About.tsx benzeri) */}
              <div className="p-8 bg-neutral-50 border-t border-border/10 text-center">
                <p className="text-lg font-medium text-[#0B3B5C] mb-4">
                  Ready to apply this standard to your vessel?
                </p>
                <HashLink
                  href="/request-consultation"
                  className="inline-block bg-[#D4AF37] text-black font-medium px-8 py-3 rounded-sm shadow-lg hover:bg-[#C9A961] transition-all duration-300 uppercase tracking-wide text-sm"
                >
