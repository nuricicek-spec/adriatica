...
export default function EngineeringPlans() {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "hasOfferCatalog": {
          ...
          "itemListElement": [
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Structural Drawings", "description": "Complete structural drawings covering primary and secondary steelwork, framing, plating, and connections per classification society rules." } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "As‑Built Drawing Sets", "description": "Updated drawings reflecting the actual condition of the vessel after construction or major modifications, verified on‑site." } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Arrangement Plans", "description": "General arrangement, machinery arrangement, piping isometrics, and accommodation layouts in 2D and 3D formats." } },
            { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Fire & Safety Plans", "description": "Fire control plans, emergency escape routes, and safety equipment location drawings compliant with SOLAS and flag state requirements." } }
          ]
        }
      }
    ]
  ...
  return (
    <>
      ...
      />
      <Helmet>
        <script type="application/ld+json">{JSON.stringify(serviceSchema).replace(/</g, '\\u003c')}</script>
      </Helmet>
      <div className="min-h-screen bg-background font-body">
        ...
        <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <div className="max-w-none text-muted-foreground">
            <p className="text-lg font-medium text-primary italic border-l-4 border-primary pl-6 mb-6">Incomplete or inaccurate engineering drawings are a primary source of construction delays, budget overruns, and class approval bottlenecks. We produce precise, classification-ready drawing sets that eliminate ambiguity and keep your project on schedule.</p>
            ...
            <div className="flex justify-center my-6">
              <img src="/images/services/engineering-plans-schema.svg" alt="Engineering plans development workflow diagram" className="w-full max-w-2xl h-auto" loading="lazy" width={672} height={400} />
            </div>
            <div className="mt-8 space-y-6">
              <div className="border-l-2 border-primary/20 pl-6">
                <h3 className="font-display text-xl font-bold text-[#0B3B5C] mb-3">Structural Drawings</h3>
                <p className="text-muted-foreground">You receive complete structural drawings covering your vessel's primary and secondary steelwork, including framing, plating, and connections. All drawings are prepared in accordance with the applicable classification society rules (RINA, BV, DNV) and include fabrication details, material specifications, and welding procedures. We also provide 3D models and finite element analysis (FEA) results when required for complex structures.</p>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <p className="text-muted-foreground">After construction or major modifications, we update the original drawings to reflect the actual condition of your vessel. This includes verifying measurements on‑site and incorporating any field changes. The final as‑built set is essential for future maintenance, modifications, and compliance documentation.</p>
                <p className="text-muted-foreground mt-2"><span className="font-medium">Process:</span> On‑site physical verification ensures the accuracy of the as‑built documentation.</p>
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <p className="text-muted-foreground">General arrangement (GA), machinery arrangement, piping isometrics, and accommodation layouts. We ensure that all spaces and systems are clearly documented, with proper labelling of equipment, access points, and emergency exits. Drawings are produced in both 2D and 3D formats as needed.</p>
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
            ...
            <div className="mt-12 p-8 bg-neutral-50 border-l-2 border-primary/20 rounded-sm text-center">
              <p className="text-lg font-medium text-[#0B3B5C] mb-2">Ready to get your engineering plans in place?</p>
              <Link href="/request-consultation" className="inline-block mt-2 bg-[#0B3B5C] text-white px-6 py-3 rounded-sm font-medium hover:bg-[#1A4B7A] transition-colors">Request Technical Assessment</Link>
            </div>
          </div>
