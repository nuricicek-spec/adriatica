  ...
  const serviceSchema = {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "WebPage",
        "@id":
          "https://www.adriaticadoo.com/services/engineering-documentation/#webpage",
          ...
          itemListElement: [
            ...
            },
            {
              ...
              itemOffered: {
                ...
                description:
                  "Detailed assessment of vessel electrical power balance, generator sizing, and distribution system capacity submitted to class for approval.",
              },
            },
            {
              "@type": "Offer",
              itemOffered: {
                ...
                description:
                  "Structured guide to fuel handling, storage, consumption, and MARPOL Annex VI compliance procedures.",
              },
            },
            {
              "@type": "Offer",
              itemOffered: {
                ...
                description:
                  "Comprehensive hazardous materials inventory prepared per Hong Kong Convention and EU Ship Recycling Regulation.",
              },
            },
          ],
        },
        ...
        <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <div className="max-w-none text-muted-foreground">
            <p className="text-lg font-medium text-primary italic border-l-4 border-primary pl-6 mb-6">
              Incomplete or outdated documentation is one of the most common
              causes of failed inspections and operational inefficiencies. We
              produce vessel-specific engineering documentation aligned with
              IMO, EU MRV, and class requirements — ensuring audit readiness and
              technical clarity.
            </p>
            ...
            <div className="flex justify-center my-6">
              <img
                ...
                alt="Vessel engineering documentation workflow"
            ...
            <div className="mt-8 space-y-6">
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <p className="text-muted-foreground">
                  You receive complete piping and instrumentation diagrams
                  (P&amp;IDs) that reflect the final installed systems,
                  including all valves, pumps, sensors, and control loops. These
                  are compiled into system manuals that also include operational
                  descriptions, troubleshooting guides, and maintenance
                  schedules – delivered in both printed and digital formats for
                  easy access.
                </p>
                <p className="text-muted-foreground mt-2">
                  <span className="font-medium">Process:</span> On‑site
                  verification and physical survey ensure accuracy of as‑built
                  documentation.
                </p>
                ...
                <p className="text-muted-foreground">
                  A comprehensive reference that supports crew training, reduces
                  downtime, and simplifies future modifications.
                </p>
              </div>
              <div className="border-l-2 border-primary/20 pl-6">
                <h3 className="font-display text-xl font-bold text-[#0B3B5C] mb-3">
                ...
                <p className="text-muted-foreground">
                  ...
                  balance, identifying peak loads, generator sizing, and
                  distribution system capacity. We use advanced calculation
                  tools and consider all operational modes (navigation,
                  manoeuvring, harbour, emergency). The analysis is submitted to
                  class for approval – essential for generator scheduling and
                ...
                <p className="text-muted-foreground">
                  Class‑approved load analysis, optimised generator operation,
                  and a solid basis for any electrical system changes.
                </p>
              </div>
              <div className="border-l-2 border-primary/20 pl-6">
                <h3 className="font-display text-xl font-bold text-[#0B3B5C] mb-3">
                ...
                <p className="text-muted-foreground">
                  A structured guide to fuel handling, storage, and consumption.
                  It includes procedures for bunkering, sampling, and reporting,
                  as well as guidance on maintaining fuel quality to avoid
                  engine damage and ensure compliance with MARPOL Annex VI. We
                  also incorporate fuel‑oil changeover procedures and sulphur
                  content recording requirements.
                </p>
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">
                  Outcome
                </h4>
                <p className="text-muted-foreground">
                  Clear, enforceable procedures that help maintain fuel quality,
                  reduce operational costs, and pass PSC inspections.
                </p>
              </div>
              <div className="border-l-2 border-primary/20 pl-6">
                <h3 className="font-display text-xl font-bold text-[#0B3B5C] mb-3">
                ...
                <p className="text-muted-foreground">
                  A comprehensive list of hazardous materials on board, prepared
                  in accordance with the Hong Kong Convention and EU Ship
                  Recycling Regulation. We conduct a thorough review of vessel
                  documentation and, if necessary, on‑board sampling to identify
                  materials such as asbestos, PCBs, and ozone‑depleting
                  substances. The IHM is essential for end‑of‑life planning and
                ...
                <p className="text-muted-foreground">
                  A complete, compliant IHM that facilitates recycling, protects
                  crew health, and meets regulatory requirements.
                </p>
              </div>
            </div>
