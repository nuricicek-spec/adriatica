  ...
  const serviceSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Hull condition analysis, fatigue life and life extension studies per IACS UR Z10, structural modification calculations, and vibration/noise diagnostics for classification society approval.",
        "url": "https://www.adriaticadoo.com/services/structural-integrity",
        "provider": { "@id": "https://www.adriaticadoo.com/#organization" },
        "isPartOf": { "@id": "https://www.adriaticadoo.com/services/structural-integrity/#webpage" },
        "areaServed": [
          ...
          <div className="max-w-none text-muted-foreground">
            ...
            <div className="flex justify-center my-6">
              <img
                ...
                alt="Structural integrity assessment timeline: baseline survey, intermediate survey, special survey, and life extension study aligned with IACS UR Z10"
            ...
            <div className="mt-8 space-y-6">
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <p className="text-muted-foreground mt-2">
                  <span className="font-medium">Typical outcome:</span> Extends operational life by 5–10 years, subject to Class approval.
                </p>
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">A clear path to extend your vessel's safe operational life while minimising downtime and avoiding unplanned repairs.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">An objective assessment that supports classification renewal, insurance surveys, and your strategic maintenance planning.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">Safe, compliant modifications delivered on time, with minimal impact on your vessel operations.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">Improved crew comfort, reduced equipment wear, and compliance with noise regulations – giving you peace of mind.</p>
              </div>
            </div>
