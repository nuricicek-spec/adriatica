  ...
  const serviceSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Technical management of dry‑dockings, refits, and modifications including on‑site owner's representation, specification development, tender management, cost/schedule control, and yard supervision to deliver on time with full documentation.",
        "url": "https://www.adriaticadoo.com/services/project-management",
        "provider": { "@id": "https://www.adriaticadoo.com/#organization" },
        "isPartOf": { "@id": "https://www.adriaticadoo.com/services/project-management/#webpage" },
        "areaServed": [
          ...
          <div className="max-w-none text-muted-foreground">
            ...
            <div className="flex justify-center my-6">
              <img
                ...
                alt="Project management lifecycle: technical brief, detailed planning and specification, yard execution and supervision, final documentation and handover"
            ...
            <div className="mt-8 space-y-6">
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <p className="text-muted-foreground">A fully managed refit with transparent communication, quality assurance, and no surprises.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">A well‑planned, efficiently executed dry‑docking that returns your vessel to service on time.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">Swift, informed decision‑making that keeps your project on track.</p>
              </div>
              ...
              <div className="border-l-2 border-primary/20 pl-6">
                ...
                <h4 className="font-display text-md font-bold text-[#0B3B5C] mt-4 mb-1">Outcome</h4>
                <p className="text-muted-foreground">Predictable outcomes with no cost overruns or schedule slippages.</p>
              </div>
            </div>
