    ...
    "@graph": [
      {
        ...
        description:
          "Adriatica D.O.O. is an independent marine engineering consultancy based in Montenegro, serving superyachts and commercial vessels across the Adriatic and Mediterranean.",
        ...
        <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          */}
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground">
            <p className="mb-6">
              Founded in Montenegro, Adriatica bridges the gap between complex
              maritime regulations and practical vessel management. You don't
              just get a consultant — you get an engineer who builds compliance,
              performance, and peace of mind for vessel operators worldwide,
              with a strong focus on the Adriatic and Mediterranean.
            </p>
            ...
            <p>
              We support vessels across the Adriatic Sea and the Mediterranean
              Basin — from commercial ports like Bar (Montenegro), Durrës
              (Albania), Rijeka, Split, Ploče (Croatia) to yacht destinations
              such as Tivat, Dubrovnik, and Monaco. Beyond the region, we
              provide global engineering management and technical advisory
              services to keep you compliant and operationally excellent
              anywhere.
            </p>
            ...
            <div className="bg-primary/5 border-l-4 border-primary p-5 mb-8 rounded-sm">
              ...
              <p className="text-xl font-display font-bold text-[#0B3B5C]">
                The Adriatica Integrity Cycle
              </p>
              <p className="text-base font-medium text-primary mt-1">
                Align · Execute · Verify
              </p>
              <p className="text-muted-foreground text-sm mt-2">
                A structured methodology that ensures compliance, efficiency,
                and peace of mind — from initial assessment to final
                documentation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="border-l-2 border-primary/20 pl-4">
                <h3 className="font-bold text-[#0B3B5C] mb-2">
                  Risk‑Based Approach
                </h3>
                <p className="text-sm">
                  We focus on niche areas, coating condition, and your
                  operational profile — delivering targeted, cost‑effective
                  solutions.
                </p>
              </div>
              <div className="border-l-2 border-primary/20 pl-4">
                ...
                <p className="text-sm">
                  We know Port State Control expectations in the Adriatic and
                  Mediterranean inside out — your vessel stays compliant and
                  disruption‑free.
                </p>
              </div>
              <div className="border-l-2 border-primary/20 pl-4">
                ...
                <p className="text-sm">
                  You get management, certification, and full documentation —
                  every project backed by rigorous engineering analysis and
            ...
            <p className="mb-2">
              Our philosophy is rooted in timeless principles — wisdom,
              resilience, and reduction to the essential.
            </p>
            <HashLink
              href="/philosophy"
            ...
            <p className="mb-4">
              We align with international and regional maritime frameworks to
              protect your vessel:
            </p>
            <div className="flex flex-wrap gap-3 text-sm text-muted-foreground border-t border-border/20 pt-4 mt-2">
              <span className="bg-neutral-100 px-3 py-1 rounded-full">
                Classification societies (DNV, BV, RINA)
              </span>
              <span className="bg-neutral-100 px-3 py-1 rounded-full">
                IMO Guidelines (biofouling, MARPOL, etc.)
              </span>
              <span className="bg-neutral-100 px-3 py-1 rounded-full">
                Paris MoU
              </span>
            ...
            <div className="mt-8 p-6 bg-neutral-50 border-l-2 border-primary/20 rounded-sm">
              <h3 className="font-display text-lg font-bold text-[#0B3B5C] mb-2">
                Company Information
              </h3>
            ...
            <div className="mt-12 p-8 bg-neutral-50 border-l-2 border-primary/20 text-center rounded-sm">
              <p className="text-lg font-medium text-[#0B3B5C] mb-2">
                Ready to align your vessel with the latest compliance
                expectations?
              </p>
              <HashLink
