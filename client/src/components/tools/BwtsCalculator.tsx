        ...
        <div className="p-4 bg-neutral-50 rounded-sm border border-border/20">
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <label
                key={opt.val}
                className="flex items-center gap-2 cursor-pointer p-2 border rounded-sm text-xs hover:bg-white transition"
              >
                <input
                  type="radio"
                  name="margin"
      ...
      {result !== null && (
        <div ref={pdfRef} className="mt-6 p-6 bg-white border-2 border-primary rounded-sm no-break">
          ...
          <div className="bg-gray-50 p-3 rounded-sm border text-xs text-gray-700">
            ...
            <p>
              When selecting a BWTS vendor, ensure the system's rated capacity (at the worst-case
              filtrate differential pressure) meets or exceeds this calculated value. Undersized
              systems lead to bypass scenarios during peak ballast operations, resulting in PSC
              deficiencies under the BWM Convention.
            </p>
          </div>
