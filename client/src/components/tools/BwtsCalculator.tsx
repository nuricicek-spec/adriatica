      ...
      {result !== null && (
        <div ref={pdfRef} className="mt-6 p-6 bg-white border-2 border-primary rounded-sm no-break">
          ...
          <div className="mt-4 bg-gray-50 p-3 rounded-sm border text-[10px] text-gray-600 leading-relaxed">
            ...
            <p>BWTS capacity sized on peak simultaneous ballast pump discharge flow multiplied by a user-defined safety factor. "Simultaneous" refers to pumps that can discharge into the ballast system at the same time during worst-case operations. Does not account for filter backwash volumes or OEM-specific self-cleaning cycles.</p>
          </div>
        </div>
      )}
