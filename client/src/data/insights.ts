...
export const insights: Insight[] = [
  {
    ...
    contentHtml: `
      ...
      <table class="w-full border-collapse border border-border text-sm my-8">
        <thead>
