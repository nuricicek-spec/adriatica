...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Independent technical surveys for yachts: pre-purchase, damage assessment, insurance valuation, charter inspection, and off-hire surveys. IACS‑aligned, class‑recognized reports.",
    deliverables: [
      "Pre‑purchase Survey",
    ...
    outcome:
      "Independent, actionable survey reports that support purchase decisions, insurance claims, and charter compliance.",
