...
export const technicalOperations: Insight = {
  ...
  contentHtml: `
    ...
    <ul class="list-disc pl-6 space-y-2">
      <li><strong>Regulatory Compliance:</strong> Aligning with the Montenegrin Maritime Safety and Port Management Administration (UPSUL) requirements [1] (see also Paris MoU Guidance Note No. 20 [2]), which are increasingly harmonizing with EU standards.</li>
      <li><strong>Infrastructural Navigation:</strong> Coordinating complex technical works across specialized hubs like Adriatic 42 (Bijela) and Navar (Tivat) [4], where local knowledge directly impacts project timelines.</li>
    </ul>
    ...
    <ul class="list-disc pl-6 space-y-2">
      <li><strong>Local Regulatory Fluency:</strong> Direct coordination with Port Authorities in Bar, Tivat, and Kotor to ensure all technical certifications meet local and Paris MoU expectations [1,2].</li>
    ...
    <p>A 55‑meter motor yacht scheduled a 6‑week refit at Adriatic 42 (Bijela). Adriatica provided full‑time on‑site engineering supervision, coordinating coating specifications, shaft alignment verification, and niche‑area biofouling documentation. The project was completed two days ahead of schedule, with all technical records accepted by the vessel's classification society and local Port Authority [5].</p>
    ...
    <ul class="list-disc pl-6 space-y-2">
      ...
      <li><strong>Regulatory Shielding:</strong> Ensuring the vessel's "biological passport" and technical records align with both international (IMO 2026) and local Adriatic biosecurity trends [2,3].</li>
    </ul>
