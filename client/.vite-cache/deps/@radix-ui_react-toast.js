...
function createCollection(name) {
  ...
  const [createCollectionContext, createCollectionScope2] =
    createContextScope(PROVIDER_NAME2);
  const [CollectionProviderImpl, useCollectionContext] =
    createCollectionContext(PROVIDER_NAME2, {
  ...
  const CollectionSlot = import_react.default.forwardRef(
    (props, forwardedRef) => {
      ...
      return (0, import_jsx_runtime.jsx)(CollectionSlotImpl, {
        ref: composedRefs,
        children,
      });
    },
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Collection.Provider, {
    scope: __scopeToast,
    children: (0, import_jsx_runtime2.jsx)(ToastProviderProvider, {
      scope: __scopeToast,
      label,
      duration,
      swipeDirection,
      ...
      onToastAdd: React2.useCallback(
        () => setToastCount((prevCount) => prevCount + 1),
        [],
      ),
      onToastRemove: React2.useCallback(
        () => setToastCount((prevCount) => prevCount - 1),
        [],
      ),
...
var ToastViewport = React2.forwardRef((props, forwardedRef) => {
  const {
    __scopeToast,
  ...
  return (0, import_jsx_runtime2.jsxs)(Branch, {
    ref: wrapperRef,
    role: "region",
    ...
    children: [
      hasToasts &&
        (0, import_jsx_runtime2.jsx)(FocusProxy, {
      ...
      (0, import_jsx_runtime2.jsx)(Collection.Slot, {
        scope: __scopeToast,
        children: (0, import_jsx_runtime2.jsx)(Primitive.ol, {
          tabIndex: -1,
          ...viewportProps,
          ref: composedRefs,
        }),
...
var FocusProxy = React2.forwardRef((props, forwardedRef) => {
  const { __scopeToast, onFocusFromOutsideViewport, ...proxyProps } = props;
  const context = useToastProviderContext(FOCUS_PROXY_NAME, __scopeToast);
  return (0, import_jsx_runtime2.jsx)(VisuallyHidden, {
    "aria-hidden": true,
    tabIndex: 0,
    ...proxyProps,
    ref: forwardedRef,
...
var Toast = React2.forwardRef((props, forwardedRef) => {
  const {
    forceMount,
    open: openProp,
    defaultOpen,
  ...
  return (0, import_jsx_runtime2.jsx)(Presence, {
    ...
    children: (0, import_jsx_runtime2.jsx)(ToastImpl, {
      open,
      ...toastProps,
      ref: forwardedRef,
...
var ToastImpl = React2.forwardRef((props, forwardedRef) => {
  const {
    __scopeToast,
    type = "foreground",
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [
      announceTextContent &&
        (0, import_jsx_runtime2.jsx)(ToastAnnounce, {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime2.jsx)(ToastInteractiveProvider, {
        scope: __scopeToast,
        onClose: handleClose,
        children: ReactDOM.createPortal(
          (0, import_jsx_runtime2.jsx)(Collection.ItemSlot, {
            scope: __scopeToast,
            children: (0, import_jsx_runtime2.jsx)(Root, {
              ...
              children: (0, import_jsx_runtime2.jsx)(Primitive.li, {
                role: "status",
                "aria-live": "off",
                "aria-atomic": true,
                tabIndex: 0,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced
    ? null
    : (0, import_jsx_runtime2.jsx)(Portal, {
        asChild: true,
...
var ToastTitle = React2.forwardRef((props, forwardedRef) => {
...
var ToastDescription = React2.forwardRef((props, forwardedRef) => {
...
var ToastAction = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(ToastAnnounceExclude, {
    altText,
    asChild: true,
    children: (0, import_jsx_runtime2.jsx)(ToastClose, {
      ...actionProps,
      ref: forwardedRef,
    }),
  });
...
var ToastClose = React2.forwardRef((props, forwardedRef) => {
